...
* [Vision_Transformer_Modeling.ipynb](https://github.com/sergio-sanz-rodriguez/Vision-Transformers-Image-Classification/blob/main/notebooks/Vision_Transformer_Modeling_v2.ipynb): Includes more ViT models trained with an input image size of 384x384 instead of 224x224. This requires loading other non-default pretrained weights, particularly [ViT_B_16_Weights.IMAGENET1K_SWAG_E2E_V1](https://pytorch.org/vision/main/models/generated/torchvision.models.vit_b_16.html#torchvision.models.vit_b_16).
